...
class Explosion(pygame.sprite.Sprite):
    ...
    def __init__(self, x: int, y: int, size: int = 32, velocity: tuple[int, int] = (0, 0), anim_delay: int = 2):
        super().__init__()
        ...
        self.animation_delay = anim_delay  # NEU: Übernimmt jetzt den Parameter (Standard: 2)
